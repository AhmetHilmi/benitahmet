...
exports.run = (client, message) => {
 dbl.hasVoted(message.author.id).then(voted => {
  if (!voted) { message.channel.send(`**Avatar Komutunu Kullanmak İçin Botumuza Oy Vermelisin** https://top.gg/bot/754356802644344934 | Eğer Oy Verdiyseniz 3 Dakika Bekleyin**`) 
